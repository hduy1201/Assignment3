...
import {
  getSneakerDetailFromFB,
  deleteSneakerFromFB,
  fetchAll,
} from "../redux/actions/sneaker";
      ...
      <View style={styles.item} key={item.id}>
        ...
        <View style={styles.info}>
          ...
          <View style={styles.color}>
            <Text
              style={{ letterSpacing: "3px", fontWeight: "bold", fontSize: 16 }}
            >
              COLORS AVAILABLE
            </Text>
            <View style={styles.row}>
              ...
              <Image
                style={styles.rowImg}
                source={{
                  uri: "https://kingshoes.vn/data/upload/media/gia%CC%80y-adidas-nasa-nmdr1-spectoo-footwear-white-fx6818-king-shoes-sneaker-real-hcm-3.jpg",
                }}
              />
              <Image
                style={styles.rowImg}
                source={{
                  uri: "https://kingshoes.vn/data/upload/media/gia%CC%80y-adidas-nasa-nmdr1-spectoo-footwear-white-fx6818-king-shoes-sneaker-real-hcm-4.jpg",
                }}
              />
            </View>
          </View>
